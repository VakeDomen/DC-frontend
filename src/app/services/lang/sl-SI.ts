export const code = "sl-SI";
export const icon = "sl-SI.png";
export const translations = {
    ...
    "Retype password": "Ponovno vpišite geslo",
    "Sign up": "Prijavi se",
    "Logout": "Odjavi se",
